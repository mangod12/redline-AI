...
class Call(TenantModel):
    ...
    transcripts = relationship(
        "Transcript", back_populates="call", cascade="all, delete"
    )
    severity_reports = relationship(
        "SeverityReport", back_populates="call", cascade="all, delete"
    )
    analysis_results = relationship(
        "AnalysisResult", back_populates="call", cascade="all, delete"
    )
    dispatch_recommendations = relationship(
        "DispatchRecommendation", back_populates="call", cascade="all, delete"
    )
